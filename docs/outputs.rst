   ...
   xcp_d/
      ...
      sub-<label>/[ses-<label>/]
         func/
            ...
            <source_entities>_space-<label>_atlas-<label>_measure-fishercorrelation_desc-<INT>volumes_conmat.tsv
            ...
            <source_entities>_space-fsLR_atlas-<label>_den-91k_measure-fishercorrelation_desc-<INT>volumes_conmat.tsv

...
def run_tests(test_regex, test_mark):
    ...
    run_str += (
        ...
        f"--data_dir={mounted_code}/xcp_d/tests/data/test_data "
        f"--output_dir={mounted_code}/xcp_d/tests/data/test_data/run_pytests/out "
        f"--working_dir={mounted_code}/xcp_d/tests/data/test_data/run_pytests/work "
    )
    if test_regex:

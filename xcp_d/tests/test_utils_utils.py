...
def test_estimate_brain_radius(pnc_data):
...
def test_denoise_with_nilearn(pnc_data, tmp_path_factory):
...
def test_get_bold2std_and_t1w_xfms(pnc_data):
    """Test get_bold2std_and_t1w_xfms."""
    bold_file_nlin2009c = pnc_data["nifti_file"]
    nlin2009c_to_anat_xfm = pnc_data["template_to_anat_xfm"]
    anat_to_native_xfm = pnc_data["anat_to_native_xfm"]
...
def test_get_std2bold_xfms(pnc_data):

...
def test_write_derivative_description(datasets, tmp_path_factory, caplog):
    ...
    with pytest.raises(FileNotFoundError, match="Dataset description DNE"):
        xbids.write_derivative_description(
            tmpdir, tmpdir, atlases=None, custom_confounds_folder=None
        )
    ...
    xbids.write_derivative_description(
        fmri_dir, tmpdir, atlases=None, custom_confounds_folder=None
    )
    ...
    xbids.write_derivative_description(tmpdir, tmpdir, atlases=None, custom_confounds_folder=None)

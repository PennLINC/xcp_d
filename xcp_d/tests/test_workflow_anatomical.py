...
def surface_files(datasets, tmp_path_factory):
    ...
    files = {
        "native_lh_inflated": os.path.join(anat_dir, "sub-01_hemi-L_inflated.surf.gii"),
        "native_lh_midthickness": os.path.join(anat_dir, "sub-01_hemi-L_midthickness.surf.gii"),
        ...
        "native_rh_inflated": os.path.join(anat_dir, "sub-01_hemi-R_inflated.surf.gii"),
        "native_rh_midthickness": os.path.join(anat_dir, "sub-01_hemi-R_midthickness.surf.gii"),
        ...
        # Copied files
        "native_lh_vinflated": os.path.join(tmpdir, "sub-01_hemi-L_vinflated.surf.gii"),
        ...
        "native_rh_vinflated": os.path.join(tmpdir, "sub-01_hemi-R_vinflated.surf.gii"),
    ...
    shutil.copyfile(files["native_lh_inflated"], files["native_lh_vinflated"])
    ...
    shutil.copyfile(files["native_rh_inflated"], files["native_rh_vinflated"])

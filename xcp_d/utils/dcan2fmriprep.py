...
def dcan2fmriprepx(dcan_dir, out_dir, sub_id):
    ...
    for ses in ses_id:
        ...
        pialR = glob.glob(anat_dirx + "_/fsaverage_LR32k/*R.pial.32k_fs_LR.surf.gii")[0]
        ...
        regfile1 = (
            anatdir + sub_id + "_" + sess + "_from-T1w_to-MNI152NLin2009cAsym_mode-image_xfm.h5"
        )
        regfile2 = (
            anatdir + sub_id + "_" + sess + "_from-MNI152NLin2009cAsym_to-T1w_mode-image_xfm.h5"
        )
        ...
        for ttt in taskid:
            ...
            bbreg = (
                ...
                + taskname
                + run_id
                + "_desc-bbregister_bold.svg"
            )
            bbreg = bbregplot(
                fixed_image=tw1, moving_image=boldref, out_file=bbreg, contour=ribbon
            )

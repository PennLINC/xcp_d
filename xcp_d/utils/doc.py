...
enable_bandpass_filter : :obj:`bool`
...
high_pass : :obj:`float`
    ...
    Bandpass filtering will only be performed if ``enable_bandpass_filter`` is True.
...
atlas_names : :obj:`list` of :obj:`str`
    ...
    The atlases include: "4S152Parcels", "4S252Parcels", "4S352Parcels", "4S452Parcels",
    "4S552Parcels", "4S652Parcels", "4S752Parcels", "4S852Parcels", "4S952Parcels",
    "4S1052Parcels", "Glasser", "Gordon", "Tian", and "HCP".
"""

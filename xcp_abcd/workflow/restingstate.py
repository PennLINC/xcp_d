...
"""         .format(kernelsize=str(smoothing))
            ...
            lh_midthickness = str(get_template("fsLR", hemi='L',suffix='midthickness',density='32k'))
            rh_midthickness = str(get_template("fsLR", hemi='R',suffix='midthickness',density='32k'))
